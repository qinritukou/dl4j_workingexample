...
import FMCore.PointWiseGradientDescent;
...
public class MovieRankingPrediction {
    public static void main(String... args) throws IOException {
        final String folderPath = "D:/data/ml-1m";
        final String indexPath = "D:/data/ml-1m/index";
        ...
        String outFileName = "D:/data/ml-1m/outFolder/Ranking_RMSE.txt";
