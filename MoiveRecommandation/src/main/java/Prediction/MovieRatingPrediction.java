...
import DataUtils.DataProvider;
import DataUtils.LibSVMDataProvider;
import FMCore.DataMetaInfo;
import FMCore.FmLearn;
import FMCore.FmLearnSgd;
import FMCore.FmLearnSgdElement;
import FMCore.FmModel;
...
public class MovieRatingPrediction {
	private static String formattedDataPath = "D:/data/ml-1m/formatted_data";
	private static String outFolder = "D:/data/ml-1m/outFolder";
	...
	public static void main(String[] args) throws Exception {
		...
		final String rLog = outFolder + "/" + "metrics_logs.txt";
